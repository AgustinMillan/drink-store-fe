...
const API_BASE_URL = "https://drink-store-production.up.railway.app/api";
...
export const productApi = {
  ...
  getLowStock: (threshold = 5) =>
    apiService.get(`/products/low-stock?threshold=${threshold}`),
...
export const supplierApi = {
  ...
  update: (id, supplierData) =>
    apiService.put(`/suppliers/${id}`, supplierData),
...
export const supplierProductPriceApi = {
  ...
  getBySupplierId: (id) =>
    apiService.get(`/supplier-product-prices/supplier/${id}`),
  getByProductId: (id) =>
    apiService.get(`/supplier-product-prices/product/${id}`),
  create: (priceData) => apiService.post("/supplier-product-prices", priceData),
  update: (id, priceData) =>
    apiService.put(`/supplier-product-prices/${id}`, priceData),
...
export const saleApi = {
  ...
  getTodayFinancialReport: () =>
    apiService.get("/sales/financial-report/today"),
