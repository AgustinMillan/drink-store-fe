...
function AddPromotionModal({ isOpen, onClose, onSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const result = await promotionApi.create(promotionData)
      ...
      if (result.success) {
        ...
        setErrors({ submit: result.error || 'Error al crear la promoción' })
      }
    } catch (error) {
    ...
    <div className="modal-overlay" onClick={handleClose}>
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        <div className="modal-header">
          <h2 className="modal-title">AGREGAR PROMOCIÓN</h2>
